<section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Portfolio</h2>
          <p>In the following, I will show some documentation of the achievements that I have achieved so far</p>
        </div>
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">pengembang usaha</li>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                ...
                <a href="index.php?hal=home" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
